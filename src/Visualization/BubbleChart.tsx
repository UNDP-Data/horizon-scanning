...
export const BubbleChart = (props: Props) => {
  ...
  useEffect(() => {
    ...
    forceSimulation(dataTemp as any)
      .force('x', forceX((d: SignalDataTypeForBubbleChart) => (d['Survey Risk (Average)'] ? xScale(d['Survey Risk (Average)'] as number) : graphWidth - (rightPadding / 2))).strength(5))
